...
namespace MatrixSolver
{
    ...
    class Thermo
    {
        public Dictionary<string, string[][]> SpeciesDatabase()
        {
            Dictionary<string, string[][]> speciesDatabase = new Dictionary<string, string[][]>();
            speciesDatabase.Add("H", new string[][] {
        ...
        speciesDatabase.Add("H2", new string[][] {
        ...
        speciesDatabase.Add("H2O", new string[][] {
        ...
        speciesDatabase.Add("O", new string[][] {
        ...
        speciesDatabase.Add("O2", new string[][] {
        ...
        public Dictionary<string, DataStructure> BuildSpeciesData(string[] speciesList)
        {
            var speciesDatabase = SpeciesDatabase();
            var speciesData = new Dictionary<string, DataStructure>();

            for (var i = 0; i < speciesList.Length; i++)
            {
                speciesData.Add(speciesList[i], Build(speciesDatabase[speciesList[i]]));
            }
